...
class DataStore:
    ...
    def _seed_data(self):
        ...
        # A couple of barbers
        self.add_user(Barber(self.next_user_id(), "Miguel Santos", "miguel", "barber123", "Fades & Classic Cuts"))
        self.add_user(Barber(self.next_user_id(), "Carlo Reyes", "carlo", "barber123", "Beard Grooming"))

        # A demo customer
        self.add_user(Customer(self.next_user_id(), "Juan Dela Cruz", "juan", "cust123", "0917-123-4567"))
        ...
        self.add_service(Service(self.next_service_id(), "Crew Cut", 140, 25, "Short on the sides, slightly longer on top."))
        self.add_service(Service(self.next_service_id(), "Skin Fade", 200, 45, "Precision fade with clean blend."))
        self.add_service(Service(self.next_service_id(), "Pompadour", 220, 40, "Voluminous top styled back with tapered sides."))
        self.add_service(Service(self.next_service_id(), "Undercut", 190, 35, "Short shaved sides with longer hair left on top."))
        self.add_service(Service(self.next_service_id(), "Textured Quiff", 200, 35, "Textured top styled upward and back."))
        ...
        style_names = [
            ("Classic Buzz Cut", "buzz-cut.jpg"),
            ("Crew Cut", "crew-cut.jpg"),
            ("Skin Fade", "skin-fade.jpg"),
            ("Pompadour", "pompadour.jpg"),
            ("Undercut", "undercut.jpg"),
            ("Textured Quiff", "quiff.jpg"),
